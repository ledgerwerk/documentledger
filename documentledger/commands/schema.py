...
_SCHEMAS: dict[str, dict[str, Any]] = {
    "storage": {
        ...
        "fields": [
            "schema_version", "project_uuid", "state_version",
            "last_scan_version", "last_scan_source_file_count", "last_scan_source_unit_count",
            "last_scan_doc_file_count", "last_scan_changed_source_count",
            "last_scan_affected_section_count", "last_scan_stale_doc_count",
            "last_scan_unlinked_changed_source_count", "last_scan_source_index_file",
    ...
    "scan": {
        ...
        "fields": [
            "schema", "version", "source_index_file", "source_index_hash",
            "source_file_count", "source_unit_count", "doc_file_count",
            "source_hashes", "doc_hashes", "changed_sources", "deleted_sources",
            "changed_units", "added_units", "deleted_units",
            "affected_sections", "stale_docs", "unlinked_changed_sources",
    ...
    "doc-record": {
        ...
        "fields": [
            "schema", "doc_path", "linked_sources", "sections",
            "last_fresh_scan_version", "last_fresh_hash", "notes", "version",
        ],
    },
    "mapping-batch": {
        "name": "mapping-batch",
    ...
    "migration-plan": {
        ...
        "fields": [
            "schema", "migration", "migration_id", "project_uuid",
            "source", "target", "items", "warnings", "plan_sha256",
        ],
    },
}
